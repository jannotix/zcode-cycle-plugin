...
// 3.14.1.7714 two days later. Five builds, none of them asked for. A receipt
// naming a host nobody certified on is worth nothing, so the mismatch fails
// loudly here rather than passing quietly. Update this and the fixture together,
// before a campaign starts and never during one.
//
...
// what 1.0.8 was cut for; the fifth Desktop build left the CLI alone and cost
// only these constants.
const EXPECTED_DESKTOP = "3.14.1.7714"
