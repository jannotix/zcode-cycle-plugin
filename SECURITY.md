...
`1.0.2-rc.3` is an unreleased release candidate. `1.0.2-rc.2`,
`1.0.2-rc.1` and `1.0.1` are superseded and never released; `1.0.0` is
withdrawn. None is supported for production use.
